...
export function makeSession(input = {}) {
  ...
  return {
    ...
    /* 대화 종료와 정서 측정 (전달 패키지 v2.4 — lib/termination.js).
       초롱이가 질문 횟수로 끊는 길은 없다. 마치신 뒤 고르신 표정 하나만 남는다. */
    termination_type: 'IN_PROGRESS',
    turns_used: 0,
    selected_emotion: null,   // COMFORTABLE | NEUTRAL | DISCOMFORT
    emotion_score: null,      // 3 | 2 | 1
